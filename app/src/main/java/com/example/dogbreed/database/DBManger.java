package com.example.dogbreed.database;
...
import com.example.dogbreed.models.DogData;
...
public class DBManger {
    ...
    public DBManger(Context c, Activity activity) {
        context = c;
        this.activity = activity;
    }

    public DBManger open() throws SQLException {
